...
const verfiy=(email,token,Name)=>{
    const mailoption={
        ...
        html:'<h3> Hi'+Name+' </h3><p>Thank You and welcome to Stowaway.To activate your account please click on the link below to confirm your registration.</p><p><a href="https://fast-reef-53121.herokuapp.com/authentication/verification/'+token+'">'+token+'</a></p><p>If you are having trouble clicking the link,copy and paste the URL above in your web browser</p><p>From,<br>Team Stowaway</p>'
    }
